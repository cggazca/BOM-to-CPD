...
import com.mentor.dms.contentprovider.core.config.xml.ConfigXMLProperty;
...
public class ContentProviderConfigPartClass {
  private static LinkedHashMap<String, ContentProviderConfigPartClass> ccpId2PartClassMap = new LinkedHashMap<>();
  
  private static ArrayList<ContentProviderConfigProperty> idPropertyList = new ArrayList<>();
  
  private static ArrayList<String> duplicateIDList = new ArrayList<>();
  ...
  public static void addPartClass(ContentProviderConfigPartClass paramContentProviderConfigPartClass) {
    if (ccpId2PartClassMap.containsKey(paramContentProviderConfigPartClass.getContentProviderId()))
      duplicateIDList.add(paramContentProviderConfigPartClass.getContentProviderId()); 
    ccpId2PartClassMap.put(paramContentProviderConfigPartClass.getContentProviderId(), paramContentProviderConfigPartClass);
  }
  
  public static ArrayList<String> getDuplicateIDList() {
    return duplicateIDList;
  }
  
  public static Collection<ContentProviderConfigPartClass> getPartClasses() {
    return ccpId2PartClassMap.values();
  }
  
  public static ContentProviderConfigPartClass getPartClass(String paramString) {
    return ccpId2PartClassMap.get(paramString);
  }
  
  public static Collection<ContentProviderConfigProperty> getIdProperties() {
  ...
  public String getPropertyLabel(String paramString) {
    for (ContentProviderConfigProperty contentProviderConfigProperty : this.classPropList) {
      if (paramString.equals(contentProviderConfigProperty.getContentProviderId()))
        return contentProviderConfigProperty.getContentProviderLabel(); 
    } 
    return "N/A";
  }
  
  public ContentProviderConfigProperty getCPProperty(String paramString) {
    for (ContentProviderConfigProperty contentProviderConfigProperty : this.classPropList) {
      if (paramString.equals(contentProviderConfigProperty.getContentProviderId()))
        return contentProviderConfigProperty; 
    } 
    return null;
  }
  ...
  protected void read(ConfigXMLPartClass paramConfigXMLPartClass) throws ContentProviderConfigException {
    ...
    for (ConfigXMLProperty configXMLProperty : paramConfigXMLPartClass.getProperties().getProperty()) {
      ...
      if (contentProviderConfigProperty.isIdProperty())
        idPropertyList.add(contentProviderConfigProperty); 
    } 
    Collections.sort(idPropertyList);
  }
...
/* Location:              C:\Users\z004ut2y\OneDrive - Siemens AG\Documents\01_Projects\Customers\Var Industries\varindustries_edm-eles-sample-dataset_2025-09-18_1349 (1)\Part Aggeration Service\ContentProviderCore.jar!\com\mentor\dms\contentprovider\core\config\ContentProviderConfigPartClass.class
