...
public class Restrictions {
  ...
  public static SimpleExpression eq(ContentProviderConfigProperty paramContentProviderConfigProperty, PropertyValue paramPropertyValue) {
    return new SimpleExpression(paramContentProviderConfigProperty, paramPropertyValue, SimpleExpression.OperatorType.EQUAL);
  }
  
  public static SimpleExpression ge(ContentProviderConfigProperty paramContentProviderConfigProperty, PropertyValue paramPropertyValue) {
    return new SimpleExpression(paramContentProviderConfigProperty, paramPropertyValue, SimpleExpression.OperatorType.GREATER_THAN_OR_EQUAL);
  }
  
  public static SimpleExpression gt(ContentProviderConfigProperty paramContentProviderConfigProperty, PropertyValue paramPropertyValue) {
    return new SimpleExpression(paramContentProviderConfigProperty, paramPropertyValue, SimpleExpression.OperatorType.GREATER_THAN);
  }
  ...
  public static SimpleExpression le(ContentProviderConfigProperty paramContentProviderConfigProperty, PropertyValue paramPropertyValue) {
    return new SimpleExpression(paramContentProviderConfigProperty, paramPropertyValue, SimpleExpression.OperatorType.LESS_THAN_OR_EQUAL);
  }
  ...
  public static SimpleExpression lt(ContentProviderConfigProperty paramContentProviderConfigProperty, PropertyValue paramPropertyValue) {
    return new SimpleExpression(paramContentProviderConfigProperty, paramPropertyValue, SimpleExpression.OperatorType.LESS_THAN);
  }
  
  public static SimpleExpression ne(ContentProviderConfigProperty paramContentProviderConfigProperty, PropertyValue paramPropertyValue) {
    return new SimpleExpression(paramContentProviderConfigProperty, paramPropertyValue, SimpleExpression.OperatorType.NOT_EQUAL);
  }
...
/* Location:              C:\Users\z004ut2y\OneDrive - Siemens AG\Documents\01_Projects\Customers\Var Industries\varindustries_edm-eles-sample-dataset_2025-09-18_1349 (1)\Part Aggeration Service\ContentProviderCore.jar!\com\mentor\dms\contentprovider\core\criterion\Restrictions.class
