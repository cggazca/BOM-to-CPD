...
public class ViewInECIA extends AbstractSearchResultsAction {
  ...
  public ViewInECIA() {
    super("Search in findchips.com", getImageIcon());
    setEnabled(true);
  }
  ...
  public void doAction() {
    ...
    try {
      str2 = "https://www.findchips.com/search/" + URLEncoder.encode(str1, "UTF-8");
    ...
    try {
      ...
      log.error("Unable to search using findchips.com URL: " + str2);
    } 
  }
}


/* Location:              C:\Users\z004ut2y\OneDrive - Siemens AG\Documents\01_Projects\Customers\Var Industries\varindustries_edm-eles-sample-dataset_2025-09-18_1349 (1)\Part Aggeration Service\ContentProviderCore.jar!\com\mentor\dms\contentprovider\core\actions\ViewInECIA.class
