...
public class LoadConfigAndSearchTask extends SwingWorker<ContentProviderConfig, ContentProviderSearchPanel> {
  ...
  public void done() {
    try {
      ...
      if (!(executionException.getCause() instanceof ContentProviderConfigException)) {
...
/* Location:              C:\Users\z004ut2y\OneDrive - Siemens AG\Documents\01_Projects\Customers\Var Industries\varindustries_edm-eles-sample-dataset_2025-09-18_1349 (1)\Part Aggeration Service\ContentProviderCore.jar!\com\mentor\dms\contentprovider\core\plugin\searchui\LoadConfigAndSearchTask.class
