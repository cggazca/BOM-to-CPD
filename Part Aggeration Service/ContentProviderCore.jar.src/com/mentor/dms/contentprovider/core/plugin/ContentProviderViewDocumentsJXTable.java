...
public class ContentProviderViewDocumentsJXTable extends JXTable {
  ...
  public TableCellRenderer getCellRenderer(int paramInt1, int paramInt2) {
    ...
    return (object instanceof com.mentor.dms.contentprovider.core.ContentProviderDocument) ? new ViewAttachmentButtonCellRenderer() : super.getCellRenderer(paramInt1, paramInt2);
  }
  
  public TableCellEditor getCellEditor(int paramInt1, int paramInt2) {
    Object object = getValueAt(paramInt1, paramInt2);
    return (object instanceof com.mentor.dms.contentprovider.core.ContentProviderDocument) ? new ViewAttachmentButtonCellEditor() : super.getCellEditor(paramInt1, paramInt2);
  }
  ...
  public Component prepareRenderer(TableCellRenderer paramTableCellRenderer, int paramInt1, int paramInt2) {
    ...
    if (object instanceof com.mentor.dms.contentprovider.core.ContentProviderDocument) {
...
/* Location:              C:\Users\z004ut2y\OneDrive - Siemens AG\Documents\01_Projects\Customers\Var Industries\varindustries_edm-eles-sample-dataset_2025-09-18_1349 (1)\Part Aggeration Service\ContentProviderCore.jar!\com\mentor\dms\contentprovider\core\plugin\ContentProviderViewDocumentsJXTable.class
