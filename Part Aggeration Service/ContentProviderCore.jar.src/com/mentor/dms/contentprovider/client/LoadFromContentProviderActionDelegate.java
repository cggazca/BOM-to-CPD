...
public class LoadFromContentProviderActionDelegate extends AbstractActionDelegate implements PropertyChangeListener {
  ...
  public void actionPerformed(Action paramAction, ActionEvent paramActionEvent) {
    ...
    if (this.ccp == null)
      return; 
    int i = JOptionPane.showConfirmDialog(ContentProviderGlobal.getRootFrame(), "Load External Content to " + this.resultList.size() + " selected Manufacturer Part(s)?", "Load from External Content", 0);
    if (i != 0)
      return; 
    this.progressMonitor = new ProgressMonitor(ContentProviderGlobal.getRootFrame(), "Loading from External Content...", "", 0, this.resultList.size());
...
/* Location:              C:\Users\z004ut2y\OneDrive - Siemens AG\Documents\01_Projects\Customers\Var Industries\varindustries_edm-eles-sample-dataset_2025-09-18_1349 (1)\Part Aggeration Service\ContentProviderCore.jar!\com\mentor\dms\contentprovider\client\LoadFromContentProviderActionDelegate.class
