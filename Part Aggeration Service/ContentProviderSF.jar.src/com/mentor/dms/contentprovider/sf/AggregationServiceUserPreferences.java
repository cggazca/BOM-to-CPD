...
public class AggregationServiceUserPreferences extends AbstractUserPreferences {
  private String numSearchResults = "10";
  
  private boolean bEnableProxy = true;
  
  private boolean bEnableSSLKeystore = true;
  ...
  public AggregationServiceUserPreferences(AbstractContentProvider paramAbstractContentProvider) {
  ...
  public void read() throws ContentProviderException {
    this.numSearchResults = getPreferences().get("numSearchResults", "10");
    this.bEnableProxy = (getPreferences().getBoolean("enableProxy", true) && this.appConfig.isProxyEnabled());
    this.bEnableSSLKeystore = (getPreferences().getBoolean("enableSSLKeystore", true) && this.appConfig.isSSLKeystoreEnabled());
  }
  ...
  public void initPanelUI(UserPreferencesPanel paramUserPreferencesPanel) {
    ...
    b += 2;
    paramUserPreferencesPanel.add(jLabel, "2, " + b + ", right, default");
    jLabel = new JLabel("HTTP proxy:");
    jLabel.setEnabled(this.appConfig.isProxyEnabled());
    paramUserPreferencesPanel.add(jLabel, "2, " + b + ", right, default");
    this.rbEnableProxyYes = new JRadioButton("Use toolbox settings");
    this.rbEnableProxyYes.setEnabled(this.appConfig.isProxyEnabled());
    JRadioButton jRadioButton1 = new JRadioButton("Disable");
    ...
    b += 2;
    jLabel = new JLabel("SSL keystore:");
    jLabel.setEnabled(this.appConfig.isSSLKeystoreEnabled());
    paramUserPreferencesPanel.add(jLabel, "2, " + b + ", right, default");
    this.rbEnableSSLYes = new JRadioButton("Use toolbox settings");
    this.rbEnableSSLYes.setEnabled(this.appConfig.isSSLKeystoreEnabled());
    JRadioButton jRadioButton2 = new JRadioButton("Disable");
...
/* Location:              C:\Users\z004ut2y\OneDrive - Siemens AG\Documents\01_Projects\Customers\Var Industries\varindustries_edm-eles-sample-dataset_2025-09-18_1349 (1)\Part Aggeration Service\ContentProviderSF.jar!\com\mentor\dms\contentprovider\sf\AggregationServiceUserPreferences.class
