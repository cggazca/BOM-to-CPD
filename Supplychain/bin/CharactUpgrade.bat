...
set COMMONS_CODEC=%SDD_HOME%\common\java\com\mentor\org\apache\commons\codec\commons-codec-1.14.jar
set COMMONS_LOGGING=%SDD_HOME%\common\java\com\mentor\org\apache\commons\logging\commons-logging-1.2.jar
...
%JAVA_HOME%\bin\java ^
  ...
  -cp "%CLASSPATH%" ^
  com.mentor.dms.contentprovider.sf.datamodel.charactsupgrade.CharacteristicsUpgrade ^
  %*
